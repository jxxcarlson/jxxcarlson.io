...
header =
    [ div [ class "header-logo" ]
        [ img [ alt "Author's blog", src "/img/logo.png", attribute "width" "35" ]
            []
        ]
...
footer =
    div [ class "footer" ]
        ...
        , div [ class "link" ]
            [ a [ href "https://markdown.minilatex.app/" ]
                [ text "Markdown.minilatex.app" ]
            ]
        , div [ class "link" ]
            [ a [ href "https://markdown.minilatex.app/" ]
                [ text "MathMarkdown Demo" ]
            ]
        , div [ class "link" ]
            [ a [ href "https://demo.minilatex.app/" ]
                [ text "Minilatex Demo" ]
            ]
        , div [ class "link" ]
            [ a [ href "https://reader.minilatex.app/" ]
                [ text "Minilatex Reader" ]
            ]
        , div [ class "link" ]
            [ a [ href "https://knode.io" ]
                [ text "knode.io" ]
            ]
        , div [ class "link" ]
            [ githubIcon
            , a [ href "https://github.com/jxxcarlson/" ]
                [ text "GitHub" ]
            ]
        ]
