...
**Comment.** Musical composition is, among other things, the art of balancing novelty with structure.  Pure randomness is fleetingly entertaining, but not  musically satisfying.  If it is used, it must be managed so as to yield a composition with some structure.
