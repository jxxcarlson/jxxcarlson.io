...
using some Haskell code.  See [this post](https://jxxcarlson.io/posts/2020-09-22-gen-art/)
for more information.

### Random Walk

Generate successive points in the plane using random walk and connect them by straight line segments.

<img src="/img/brownianPath.png" width=600>

### Cloud Shapes

Draw a small colored square centered at the points generated by the random walk.
