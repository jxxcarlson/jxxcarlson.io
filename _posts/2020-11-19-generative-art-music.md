...
The function `sta 0.9` renders its argument with staccato articulation.  The function
...
There is a similar function `melGen1` for generating music from the uniform distribution.
...
Need to experiment more with transparency.
